...
define(["d3", "app/eventbus", "model/config"], function (d3, eventbus, config) {
  ...
  */
  ...
  function Initiative(e) {
    ...
    const classSchema2 = [
      { propertyName: 'activity', value: codes.activity, enumerable: true, writable: true },
      { propertyName: 'baseMembershipType', value: codes.baseMembershipType, enumerable: true },
      { propertyName: 'country', value: e.country ? e.country : undefined, enumerable: true },
      { propertyName: 'dataset', value: e.dataset, enumerable: true },
      { propertyName: 'desc', value: e.desc, enumerable: true },
      { propertyName: 'email', value: e.email, enumerable: true },
      { propertyName: 'facebook', value: e.facebook, enumerable: true },
      { propertyName: 'lat', value: e.lat, enumerable: true, writable: true },
      { propertyName: 'lng', value: e.lng, enumerable: true, writable: true },
      { propertyName: 'locality', value: e.locality, enumerable: true },
      { propertyName: 'manLat', value: e.manLat, enumerable: true, writable: true },
      { propertyName: 'manLng', value: e.manLng, enumerable: true, writable: true },
      { propertyName: 'name', value: e.name, enumerable: true },
      { propertyName: 'nongeoLat', value: config.getDefaultLatLng()[0], enumerable: true },
      { propertyName: 'nongeoLng', value: config.getDefaultLatLng()[1], enumerable: true },
      { propertyName: 'orgStructure', value: [], enumerable: true, writable: true },
      { propertyName: 'otherActivities', value: [], enumerable: true, writable: true },
      { propertyName: 'postcode', value: e.postcode, enumerable: true },
      { propertyName: 'primaryActivity', value: codes.primaryActivity, enumerable: true },
      { propertyName: 'qualifier', value: codes.qualifier, enumerable: true },
      { propertyName: 'qualifiers', value: [], enumerable: true, writable: true },
      { propertyName: 'region', value: e.region, enumerable: true },
      { propertyName: 'regorg', value: codes.regorg, enumerable: true },
      { propertyName: 'searchstr', value: genSearchValues(config.getSearchedFields(), e), enumerable: true, writable: true },
      { propertyName: 'street', value: e.street, enumerable: true },
      { propertyName: 'tel', value: e.tel, enumerable: true },
      { propertyName: 'twitter', value: e.twitter, enumerable: true },
      { propertyName: 'uniqueId', value: e.uri, enumerable: true },
      { propertyName: 'uri', value: e.uri, enumerable: true },
      { propertyName: 'within', value: e.within, enumerable: true },
      { propertyName: 'www', value: e.www, enumerable: true },
    ];
